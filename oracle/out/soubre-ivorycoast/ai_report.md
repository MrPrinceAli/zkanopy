# AI QC report - soubre-ivorycoast-cocoa

Generated 2026-09-24T01:39:22+00:00. Model: RandomForestClassifier (n_estimators=300, min_samples_leaf=2, class_weight=balanced, random_state=42).

## Data

- Cells: 40000 (Hansen clean 36409, loss 3591)
...
|---|---|
| Accuracy | 0.8277 |
| F1 (loss class) | 0.2344 |
| F1 (clean class) | 0.9030 |
| F1 macro | 0.5687 |
| Precision (loss) | 0.1950 |
| Recall (loss) | 0.2939 |
...
- Cells where AI and Hansen disagree: 2855 (see `review_queue.csv`)
  - Hansen clean, AI loss: 2348 -> **blocked** by the conservative rule
  - Hansen loss, AI clean: 507 -> stay loss (Hansen wins)
- Final labels entering the Merkle tree: clean 34061, loss 5939
